...
export const Badge: React.FC<BadgeProps> = ({ variant = 'info', children, className, dot = true }) => {
  const variantStyles: Record<string, { bg: string; text: string; dotColor: string }> = {
    ...
    partially_settled: { bg: 'bg-saffron-50 border-saffron-200', text: 'text-saffron-800', dotColor: 'bg-saffron-500' },
    ...
    closed: { bg: 'bg-rose-50 border-rose-200', text: 'text-rose-800', dotColor: 'bg-rose-500' },
    ...
    cancelled: { bg: 'bg-rose-50 border-rose-200', text: 'text-rose-800', dotColor: 'bg-rose-500' },
    superseded: { bg: 'bg-cream-200/80 border-cream-300', text: 'text-gray-600', dotColor: 'bg-gray-400' },
    corrected: { bg: 'bg-amber-50 border-amber-300', text: 'text-amber-900', dotColor: 'bg-amber-500' },
    success: { bg: 'bg-emerald-50 border-emerald-200', text: 'text-emerald-800', dotColor: 'bg-emerald-500' },
    danger: { bg: 'bg-rose-50 border-rose-200', text: 'text-rose-800', dotColor: 'bg-rose-500' },
    warning: { bg: 'bg-amber-50 border-amber-200', text: 'text-amber-800', dotColor: 'bg-amber-500' },
    info: { bg: 'bg-sky-50 border-sky-200', text: 'text-sky-800', dotColor: 'bg-sky-500' },
